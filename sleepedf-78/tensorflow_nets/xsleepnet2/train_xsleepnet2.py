...
from gradient_policy2 import GradientPolicy2
...
train_size = len(train_generator_check.data_index)
valid_size = len(eval_generator.data_index)
gp_tf = GradientPolicy2(train_size=train_size, valid_size=valid_size, average_win=20)
gp_raw = GradientPolicy2(train_size=train_size, valid_size=valid_size, average_win=20)
gp_joint = GradientPolicy2(train_size=train_size, valid_size=valid_size, average_win=20)
                ...
                if current_step % config.evaluate_every == 0:
                    ...
                    if (eval_acc3 >= best_acc_joint):
                        ...
                        with open(os.path.join(out_dir, "current_best.txt"), "a") as text_file:
                            text_file.write("{:g} {:g} {:g}\n".format(train_acc3, eval_acc3, test_acc3))
