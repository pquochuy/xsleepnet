...
from gradient_policy1 import GradientPolicy1
...
gp_tf = GradientPolicy1(train_size=train_size)
gp_raw = GradientPolicy1(train_size=train_size)
gp_joint = GradientPolicy1(train_size=train_size)
