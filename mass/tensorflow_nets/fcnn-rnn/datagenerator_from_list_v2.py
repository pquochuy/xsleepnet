...
class DataGenerator:
    ...
    def next_batch(self, batch_size):
        ...
        batch_x = np.ndarray([batch_size, self.seq_len, self.data_shape[0], self.data_shape[1]])
    ...
    def rest_batch(self, batch_size):
        ...
        # after stack eeg, eog, emg, data_shape now is a 3D tensor
        batch_x = np.ndarray([actual_len, self.seq_len, self.data_shape[0], self.data_shape[1]])
