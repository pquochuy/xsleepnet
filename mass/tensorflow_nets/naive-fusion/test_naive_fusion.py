    ...
    with sess.as_default():
        ...
        def evaluate(gen):
            ...
            while test_step < num_batch_per_epoch:
                ...
                output_loss_, total_loss_, yhat_, score_ = dev_step(x1_batch, x2_batch, y_batch)
        ...
        test_acc, test_yhat, test_score, test_loss, test_total_loss = evaluate(gen=test_generator)

        savemat(os.path.join(out_path, "test_ret.mat"), dict(yhat = test_yhat,
                                                             acc = test_acc,
                                                             score = test_score,
                                                             output_loss = test_loss,
