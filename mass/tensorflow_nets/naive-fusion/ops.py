...
def downconv(x, output_dim, kwidth=5, pool=2, init=None, uniform=False, bias_init=None, name='downconv'):
    """ Downsampled convolution 1d """
    x2d = tf.expand_dims(x, 2) # expand 2
    #print("x2d")
    #print(x2d.get_shape())
    w_init = init
    if w_init is None:
    ...
    with tf.variable_scope(name):
        ...
        #print("conv after adding bias")
        #print(conv.get_shape())
        # reshape back to 1d
        #print([-1], [conv.get_shape().as_list()[1]] + [conv.get_shape().as_list()[-1]])
