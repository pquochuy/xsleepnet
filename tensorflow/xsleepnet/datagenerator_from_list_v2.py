...
class DataGenerator:
    ...
    def next_batch(self, batch_size):
        ...
        batch_x1 = np.ndarray([batch_size, self.seq_len, self.data_shape_1[0], self.data_shape_1[1], self.data_shape_1[2]])
    ...
    def rest_batch(self, batch_size):
        ...
        # after stack eeg, eog, emg, data_shape now has one more dimension
        batch_x1 = np.ndarray([actual_len, self.seq_len, self.data_shape_1[0], self.data_shape_1[1], self.data_shape_1[2]])
